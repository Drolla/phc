...
core.scheduler.Scheduler for how on_start/on_stop get invoked
(start_hooks/stop_hooks -- see core/scheduler.py)."""
...
from extensions.web_ui.panels import DevicesPanel, Panel, get_panel_kind_class
from extensions.web_ui.server import build_app
